...
// 权重。Block2 的 channel 维由 blockIdx.z 分成两个 128-pair CTA。
...
__global__ __launch_bounds__(128, 10) void block2PackedDwconvHalf2Tile2DKernel(
    ...
    output[outputPairOffset + kChannelPairs] = convertOutput(upper1);
