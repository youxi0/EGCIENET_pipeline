...
ONNX="${ONNX:-${PROJECT_ROOT}/models/egcienet_352_multiclass_qdq_v25_q_block134_kv_all_packed_sr_block3_int8.onnx}"
...
echo "[INFO] build V25 Block3 INT8 spatial-reduction engine"
echo "[INFO] onnx: ${ONNX}"
