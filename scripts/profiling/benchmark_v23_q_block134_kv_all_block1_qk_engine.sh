...
PROFILE_JSON="${PROFILE_JSON:-${PROJECT_ROOT}/results/profile/egcienet_352_multiclass_qdq_v23_q_block134_kv_all_block1_qk_profile.json}"
...
echo "[INFO] benchmark V23 Block1 attention QK Q/DQ"
"${TRTEXEC}" \
    "--loadEngine=${ENGINE}" \
