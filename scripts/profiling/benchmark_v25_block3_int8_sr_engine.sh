...
ENGINE="${ENGINE:-${PROJECT_ROOT}/models/egcienet_352_multiclass_qdq_v25_q_block134_kv_all_packed_sr_block3_int8.engine}"
...
PROFILE_JSON="${PROFILE_JSON:-${PROJECT_ROOT}/results/profile/egcienet_352_multiclass_qdq_v25_q_block134_kv_all_packed_sr_block3_int8_profile.json}"
...
echo "[INFO] benchmark V25 Block3 INT8 spatial-reduction engine"
"${TRTEXEC}" \
    "--loadEngine=${ENGINE}" \
