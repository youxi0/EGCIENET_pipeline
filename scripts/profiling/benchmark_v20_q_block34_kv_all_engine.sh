...
PROFILE_JSON="${PROFILE_JSON:-${PROJECT_ROOT}/results/profile/egcienet_352_multiclass_qdq_v20_q_block34_kv_all_profile.json}"
...
echo "[INFO] benchmark V20 attention Q/K/V MatMul Q/DQ"
"${TRTEXEC}" \
    "--loadEngine=${ENGINE}" \
