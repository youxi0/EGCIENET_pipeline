...
PROFILE_JSON="${PROFILE_JSON:-${PROJECT_ROOT}/results/profile/egcienet_352_multiclass_qdq_v24_q_block134_kv_all_packed_sr_plugin_profile.json}"
...
echo "[INFO] benchmark V24 packed spatial-reduction plugin engine"
"${TRTEXEC}" \
    "--loadEngine=${ENGINE}" \
