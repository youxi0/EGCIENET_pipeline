...
PROFILE_JSON="${PROFILE_JSON:-${PROJECT_ROOT}/results/profile/egcienet_352_multiclass_qdq_v22_q_block134_kv_all_profile.json}"
...
echo "[INFO] benchmark V22 attention Q/KV MatMul Q/DQ"
"${TRTEXEC}" \
    "--loadEngine=${ENGINE}" \
