...
PROFILE_JSON="${PROFILE_JSON:-${PROJECT_ROOT}/results/profile/egcienet_352_multiclass_qdq_v17_block3_attn_q_matmul_qdq_profile.json}"
...
echo "[INFO] benchmark V17 Block3 attention Q MatMul Q/DQ"
"${TRTEXEC}" \
    "--loadEngine=${ENGINE}" \
