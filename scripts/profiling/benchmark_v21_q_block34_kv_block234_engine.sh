...
PROFILE_JSON="${PROFILE_JSON:-${PROJECT_ROOT}/results/profile/egcienet_352_multiclass_qdq_v21_q_block34_kv_block234_profile.json}"
...
echo "[INFO] benchmark V21 attention Q/KV MatMul Q/DQ"
"${TRTEXEC}" \
    "--loadEngine=${ENGINE}" \
